...
<body>
	...
	<div class="col-md-9 main">
		<!--banner-section-->
					...
					<!--banner-->
	  			<input onClick="location.href='contribute.php' "type="button" name="poem" value="Upload Poem" >
			   <!--//banner-->
			  <!--/top-news-->
			  <div class="top-news">
				<div class="top-inner">
 ...
 directed by Sean Penn with Emile Hirsch starring as McCandless.</p>
		...
		<!--banner-section-->
			  ...
			  <div class="top-news">
				<div class="top-inner">
					<div class="col-md-6 top-text">
						 <a href="danbrown.php"><img src="images/pic5.jpg"  alt="" height="300" width="50" ></a>
						    <h5 class="top"><a href="danbrown.php">Do Not Stand at My Grave and Weep</a></h5>
						    ...
						    <p>On Jun 25 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>5.6k </a>
					...
					<div class="col-md-6 top-text two">
						 <a href="gos.html"><img src="images/pic6.jpg" height="300" width="50" alt=""></a>
						    <h5 class="top"><a href="gos.html">Stopping by Woods on a Snowy Evening</a></h5>
				 ...
				 <div class="top-inner second">
					<div class="col-md-6 top-text">
						 <a href="itw.html"><img src="images/pic7.jpg" height="300" width="50" alt=""></a>
						    <h5 class="top"><a href="itw.html">The Road Not Taken</a></h5>
							<p>
Into the Wild is a 1996 non-fiction book written by Jon Krakauer. It is an expansion of a 9,000-word article by Krakauer on Christopher McCandless
 ...
 with Emile Hirsch starring as McCandless.</p>
					...
					<div class="col-md-6 top-text two">
						 <a href="slj.html"><img src="images/pic8.jpg" height="300" width="50" alt=""></a>
						    <h5 class="top"><a href="slj.html">And Still I Rise</a></h5>
