...
<body>
	...
	<div class="full">
			<div class="col-md-3 top-nav sing-page">
					...
					<ul class="cl-effect-16">
						...
						<li><a href="stories.php" data-hover="About">stories</a></li>
						<li><a href="poems.php" data-hover="Poems">Poems</a></li>
						<li><a href="reviews.php" data-hover="Rviews">Reviews</a></li>
		...
		<div class="banner-section">
		   <h3 class="tittle">DAN BROWN <i class="glyphicon glyphicon-file"></i></h3>
			<div class="single">
			   <img src="images/pic1.jpg" class="img-responsive" alt="" />
			    <div class="b-bottom"> 
			      <h5 class="top"><a href="#">DAN BROWN</a></h5>
				  
				  <form method="get" action="danbrown.pdf" target="_blank">
	...
	<!--/footer-->
				 ...
				 <div class="footer-top">
					...
					<div class="col-md-4 footer-grid">
					     <h4>Address Location</h4>
				           <ul class="bottom">
						     <li><i class="glyphicon glyphicon-map-marker"></i>2901 SJCET, palai </li>
		...
		<div class="copy">
		    <p>&copy; 2018 Blogger. All Rights Reserved | Design by <a href="http://enterechana.com/">Enterechana.com</a> </p>
		</div>
	 <div class="clearfix"> </div>
	</div>
	<div class="clearfix"> </div>
