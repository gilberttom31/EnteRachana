...
if(isset($_POST["btnSubmit"]))
{
	...
	$mid=$_POST["mailid"];
	$pwd=$_POST["passwd"];
	$sql = "SELECT CONCAT(fname,' ',lname),mailid as name  FROM regform where mailid='$mid' and  passwd='$pwd' ";
	echo $sql;
...
<body>
	...
	<div class="full">
			<div class="col-md-3 top-nav login">
				     <div class="logo">
						<a href="index.php"><h1>Ente Rechana</h1></a>
					</div>
					<div class="top-menu">
					...
					<ul class="cl-effect-16">
						...
						<li><a href="index.php" data-hover="Stories">Stories</a></li>
						<li><a href="index.php" data-hover="Poems">Poems</a></li>
						<li><a href="index.php" data-hover="Reviews">Reviews</a></li>
	...
	<div class="login">
		<div class="login-grids">
			<div class="col-md-6 log">
					 ...
					 <form method="post">
						 <h5>E-mail Id </h5>	
						 <input type="text" required="" name="mailid" >
						 <h5>Password</h5>
...
<!-- //login-page -->
	...
	<!--/footer-->
		...
		<div class="copy">
		    <p>&copy; 2018 Blogger. All Rights Reserved | Design by <a href="http://google.com">Team EnteRechana.com</a> </p>
		</div>
	 <div class="clearfix"> </div>
	</div>
	<div class="clearfix"> </div>
