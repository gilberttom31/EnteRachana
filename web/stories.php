...
<body>
 ...
 <?php
include("dbcon.php");
$img = mysqli_query($conn, "SELECT * FROM uploads WHERE category='story' ORDER BY `date` DESC ");
?>	
		...
		while ($row = mysqli_fetch_array($img)) {
			...
			?>
					...
					<div class="col-md-4 top-text">
						 ...
						 <a href="danbrown.php">
							<img src="uploads/<?php echo $row['image'];?>"  alt="" height="300" width="50" /></a>
						    <h5 class="top"><a href="danbrown.php"><?php $imgName ?></a></h5>
